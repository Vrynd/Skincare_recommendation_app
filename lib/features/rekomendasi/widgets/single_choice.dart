...
/// Widget pilihan tunggal (Single Choice) generic dengan desain premium.
/// Mendukung penomoran opsional lewat parameter 'indexNumber'.
  ...
  Widget build(BuildContext context) {
    return AppContainer(
      ...
      child: Column(
        ...
        children: [
          // Baris Pertanyaan dengan Badge Nomor Opsional atau Bullet Default
          Row(
            children: [
              if (indexNumber != null) ...[
                Container(
